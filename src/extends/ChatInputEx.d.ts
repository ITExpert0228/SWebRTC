 ...
 *
 */
declare class ChatInputEx extends React.Component<ChatInputProps, ChatInputState> {
...
declare const _default: import("react-redux").ConnectedComponentClass<typeof ChatInputEx, Pick<ChatInputProps, never> & ChatInputProps>;
